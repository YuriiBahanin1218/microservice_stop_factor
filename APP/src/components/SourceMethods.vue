<template>
  <div>
    ...
    <div class="stop-list scroll-hide">
      <div v-for="(stop, index) of stopsArray" :key="(index + 22) * 2" class="mb-3" @click="openPanel(`panel${index}`)"
        :id="`panel${index}`">
        <div class="second-stop-item d-flex justify-space-between align-center">
          <div class="d-flex align-center">
            <div class="custom-checkbox d-flex justify-center align-center mr-3"
              @click.stop="addActive(`ccheckbox${index}`, stop)" :id="`ccheckbox${index}`">
            ...
            <span class="mr-2 d-flex align-center arrow" style="transition: 0.3s;">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="svg">
                <path d="M19 9L12 16L5 9" stroke="#576270" stroke-width="2" stroke-linecap="round"
          ...
          <div class="d-flex">
            <span class="c-circle plus d-flex justify-center align-center">
              <svg width="20" height="20" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M18 31.5L18 4.5" stroke="white" stroke-width="3.6" stroke-linecap="round"
                  stroke-linejoin="round" />
              </svg>
            </span>
            <span class="c-circle cancel d-flex justify-center align-center ml-2">
              <svg width="25" height="25" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M26.9999 26.9999L9 9" stroke="rgba(245, 43, 72, 1)" stroke-width="3.2" stroke-linecap="round"
                  stroke-linejoin="round" />
                <path d="M27.0001 9L9 27.0001" stroke="rgba(245, 43, 72, 1)" stroke-width="3.2" stroke-linecap="round"
                  stroke-linejoin="round" />
              </svg>
            </span>
          </div>
        ...
        <div class="sub-el__wrapper">
          <div v-for="(el, idx) of stop.subStops" :key="(idx + 9) * 2"
            class="d-flex justify-space-between align-center sub-el" @click.stop="">
            <div class="d-flex">
              <div class="custom-checkbox d-flex justify-center align-center mr-3"
                @click.stop="addActive(`sccheckbox${el.id}`)" :id="`sccheckbox${el.id}`">
                <img src="../../assets/accept.svg">
              </div>
              <span class="el-text">
                {{ el.text }}
            ...
            <div class="d-flex align-center pt-1">
              <span class="mr-2">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M22 12C22 6.48 17.52 2 12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22" stroke="#576270"
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <g opacity="0.4">
                    <path d="M7.99961 3H8.99961C7.04961 8.84 7.04961 15.16 8.99961 21H7.99961" stroke="#576270"
                      stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M15 3C15.97 5.92 16.46 8.96 16.46 12" stroke="#576270" stroke-width="2"
                      stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M3 16V15C5.92 15.97 8.96 16.46 12 16.46" stroke="#576270" stroke-width="2"
                      stroke-linecap="round" stroke-linejoin="round" />
                    <path d="M3 9.0001C8.84 7.0501 15.16 7.0501 21 9.0001" stroke="#576270" stroke-width="2"
                      stroke-linecap="round" stroke-linejoin="round" />
                  </g>
                  <path
                    d="M18.2 21.4C19.9673 21.4 21.4 19.9673 21.4 18.2C21.4 16.4327 19.9673 15 18.2 15C16.4327 15 15 16.4327 15 18.2C15 19.9673 16.4327 21.4 18.2 21.4Z"
                    stroke="#576270" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M22 22L21 21" stroke="#576270" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
              </span>
              <span class="mr-1">
  ...
  <div class="btn-div">
    <button class="save-btn" @click="openModal">Добавить метод</button>
  </div>
</div></template>
